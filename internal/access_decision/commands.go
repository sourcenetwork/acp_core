...
func (c *EvaluateAccessRequestsCommand) Execute(ctx context.Context, engine zanzi.Adapter, repository Repository, paramsRepo ParamsRepository) (*types.AccessDecision, error) {
	err := c.validate()
	if err != nil {
...
func (c *EvaluateAccessRequestsCommand) evaluateRequest(ctx context.Context, engine zanzi.Adapter) error {
	actor := types.Actor{
		Id: c.Actor,
	}
