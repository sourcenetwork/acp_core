...
func (r *KVParamsRepository) Set(ctx context.Context, params *types.Params) error {
	...
	if err != nil {
		return errors.NewFromCause("could not marshal params:", err, errors.ErrInput)
	}
...
func (r *KVParamsRepository) GetOrDefault(ctx context.Context) (*types.Params, error) {
	...
	if err != nil {
		...
		return nil, errors.NewFromCause("could not unmarshal stored params, considering setting it", err, errors.ErrInternal)
	}
