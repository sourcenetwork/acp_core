...
func (*GetSandboxRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_11e240bc3d9e97c1, []int{14}
}
...
func (*GetSandboxResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_11e240bc3d9e97c1, []int{15}
}
...
func init() {
	...
	proto.RegisterType((*GetSandboxRequest)(nil), "sourcenetwork.acp_core.playground.GetSandboxRequest")
	proto.RegisterType((*GetSandboxResponse)(nil), "sourcenetwork.acp_core.playground.GetSandboxResponse")
}
...
var fileDescriptor_11e240bc3d9e97c1 = []byte{
	...
	,
}
...
func (c *playgroundServiceClient) GetSandbox(ctx context.Context, in *GetSandboxRequest, opts ...grpc.CallOption) (*GetSandboxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sourcenetwork.acp_core.playground.PlaygroundService/GetSandbox", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PlaygroundService_GetSandbox_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sourcenetwork.acp_core.playground.PlaygroundService/GetSandbox",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
