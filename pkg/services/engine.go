...
func (s *EngineService) CreatePolicy(ctx context.Context, req *types.CreatePolicyRequest) (*types.CreatePolicyResponse, error) {
	handler := policy.CreatePolicyHandler{}
	h := func(ctx context.Context, req *types.CreatePolicyRequest) (*types.CreatePolicyResponse, error) {
		return handler.Execute(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) CreatePolicyWithSpecification(ctx context.Context, req *types.CreatePolicyWithSpecificationRequest) (*types.CreatePolicyWithSpecificationResponse, error) {
	handler := policy.CreatePolicyWithSpecHandler{}
	h := func(ctx context.Context, req *types.CreatePolicyWithSpecificationRequest) (*types.CreatePolicyWithSpecificationResponse, error) {
		return handler.Execute(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) EditPolicy(ctx context.Context, req *types.EditPolicyRequest) (*types.EditPolicyResponse, error) {
	handler := policy.EditPolicyHandler{}
	h := func(ctx context.Context, req *types.EditPolicyRequest) (*types.EditPolicyResponse, error) {
		return handler.Execute(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) EditPolicyMetadata(ctx context.Context, req *types.EditPolicyMetadataRequest) (*types.EditPolicyMetadataResponse, error) {
	handler := policy.EditPolicyMetadataHandler{}
	h := func(ctx context.Context, req *types.EditPolicyMetadataRequest) (*types.EditPolicyMetadataResponse, error) {
		return handler.Execute(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) SetRelationship(ctx context.Context, req *types.SetRelationshipRequest) (*types.SetRelationshipResponse, error) {
	handler := relationship.SetRelationshipHandler{}
	h := func(ctx context.Context, req *types.SetRelationshipRequest) (*types.SetRelationshipResponse, error) {
		return handler.Execute(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) DeleteRelationship(ctx context.Context, req *types.DeleteRelationshipRequest) (*types.DeleteRelationshipResponse, error) {
	handler := relationship.DeleteRelationshipHandler{}
	h := func(ctx context.Context, req *types.DeleteRelationshipRequest) (*types.DeleteRelationshipResponse, error) {
		return handler.Execute(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) RegisterObject(ctx context.Context, req *types.RegisterObjectRequest) (*types.RegisterObjectResponse, error) {
	handler := relationship.RegisterObjectHandler{}
	h := func(ctx context.Context, req *types.RegisterObjectRequest) (*types.RegisterObjectResponse, error) {
		return handler.Execute(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) ArchiveObject(ctx context.Context, req *types.ArchiveObjectRequest) (*types.ArchiveObjectResponse, error) {
	handler := relationship.ArchiveObjectHandler{}
	h := func(ctx context.Context, req *types.ArchiveObjectRequest) (*types.ArchiveObjectResponse, error) {
		return handler.Execute(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}
...
func (s *EngineService) GetObjectRegistration(ctx context.Context, req *types.GetObjectRegistrationRequest) (*types.GetObjectRegistrationResponse, error) {
	h := func(ctx context.Context, req *types.GetObjectRegistrationRequest) (*types.GetObjectRegistrationResponse, error) {
		return relationship.GetObjectRegistrationHandler(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}
...
func (s *EngineService) FilterRelationships(ctx context.Context, req *types.FilterRelationshipsRequest) (*types.FilterRelationshipsResponse, error) {
	h := func(ctx context.Context, req *types.FilterRelationshipsRequest) (*types.FilterRelationshipsResponse, error) {
		return relationship.FilterRelationshipsHandler(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) DeletePolicy(ctx context.Context, req *types.DeletePolicyRequest) (*types.DeletePolicyResponse, error) {
	h := func(ctx context.Context, req *types.DeletePolicyRequest) (*types.DeletePolicyResponse, error) {
		return policy.HandleDeletePolicy(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}
...
func (s *EngineService) ValidatePolicy(ctx context.Context, req *types.ValidatePolicyRequest) (*types.ValidatePolicyResponse, error) {
	h := func(ctx context.Context, req *types.ValidatePolicyRequest) (*types.ValidatePolicyResponse, error) {
		return policy.ValidatePolicy(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}
...
func (s *EngineService) VerifyAccessRequest(ctx context.Context, req *types.VerifyAccessRequestRequest) (*types.VerifyAccessRequestResponse, error) {
	h := func(ctx context.Context, req *types.VerifyAccessRequestRequest) (*types.VerifyAccessRequestResponse, error) {
		return authz_db.VerifyAccessRequest(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) GetPolicy(ctx context.Context, req *types.GetPolicyRequest) (*types.GetPolicyResponse, error) {
	h := func(ctx context.Context, req *types.GetPolicyRequest) (*types.GetPolicyResponse, error) {
		return policy.HandleGetPolicy(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) ListPolicies(ctx context.Context, req *types.ListPoliciesRequest) (*types.ListPoliciesResponse, error) {
	h := func(ctx context.Context, req *types.ListPoliciesRequest) (*types.ListPoliciesResponse, error) {
		return policy.ListPolicies(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}
...
func (s *EngineService) TransferObject(ctx context.Context, req *types.TransferObjectRequest) (*types.TransferObjectResponse, error) {
	h := func(ctx context.Context, req *types.TransferObjectRequest) (*types.TransferObjectResponse, error) {
...
func (s *EngineService) SetParams(ctx context.Context, req *types.SetParamsRequest) (*types.SetParamsResponse, error) {
	h := func(ctx context.Context, req *types.SetParamsRequest) (*types.SetParamsResponse, error) {
		return system.HandleSetParams(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}

func (s *EngineService) GetParams(ctx context.Context, req *types.GetParamsRequest) (*types.GetParamsResponse, error) {
	h := func(ctx context.Context, req *types.GetParamsRequest) (*types.GetParamsResponse, error) {
		return system.HandleGetParams(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}
...
func (s *EngineService) EvaluateTheorem(ctx context.Context, req *types.EvaluateTheoremRequest) (*types.EvaluateTheoremResponse, error) {
	h := func(ctx context.Context, req *types.EvaluateTheoremRequest) (*types.EvaluateTheoremResponse, error) {
		return policy.EvaluateTheorem(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}
...
func (s *EngineService) GetPolicyCatalogue(ctx context.Context, req *types.GetPolicyCatalogueRequest) (*types.GetPolicyCatalogueResponse, error) {
	h := func(ctx context.Context, req *types.GetPolicyCatalogueRequest) (*types.GetPolicyCatalogueResponse, error) {
		return policy.GetPolicyCatalogue(ctx, s.runtime, req)
	}
	return decorator.DecorateTypedHandler(h, s.decorator)(ctx, req)
}
