...
var (
	...
	fd_ManagementPermission_expr protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ManagementPermission_expr = md_ManagementPermission.Fields().ByName("expr")
}
...
func (x *fastReflection_ManagementPermission) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Expr != "" {
		...
		if !f(fd_ManagementPermission_expr, value) {
			return
		}
	}
}
...
func (x *fastReflection_ManagementPermission) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "sourcenetwork.acp_core.ManagementPermission.name":
		return x.Name != ""
	case "sourcenetwork.acp_core.ManagementPermission.expr":
		return x.Expr != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_ManagementPermission) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sourcenetwork.acp_core.ManagementPermission.expr":
		panic(fmt.Errorf("field expr of message sourcenetwork.acp_core.ManagementPermission is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcenetwork.acp_core.ManagementPermission"))
		}
...
func (x *ManagementPermission) GetExpr() string {
	if x != nil {
		return x.Expr
	}
	return ""
...
var file_sourcenetwork_acp_core_policy_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x3e, 0x0a, 0x14, 0x4d, 0x61, 0x6e, 0x61, 0x67,
	...
	0x09, 0x52, 0x04, 0x65, 0x78, 0x70, 0x72, 0x2a, 0x2d, 0x0a, 0x14, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	0x79, 0x4d, 0x61, 0x72, 0x73, 0x68, 0x61, 0x6c, 0x69, 0x6e, 0x67, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04,
	0x59, 0x41, 0x4d, 0x4c, 0x10, 0x01, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
