...
var (
	md_SandboxTemplate             protoreflect.MessageDescriptor
	fd_SandboxTemplate_name        protoreflect.FieldDescriptor
	fd_SandboxTemplate_description protoreflect.FieldDescriptor
	fd_SandboxTemplate_data        protoreflect.FieldDescriptor
)

func init() {
	file_sourcenetwork_acp_core_sandbox_proto_init()
	md_SandboxTemplate = File_sourcenetwork_acp_core_sandbox_proto.Messages().ByName("SandboxTemplate")
	fd_SandboxTemplate_name = md_SandboxTemplate.Fields().ByName("name")
	fd_SandboxTemplate_description = md_SandboxTemplate.Fields().ByName("description")
	fd_SandboxTemplate_data = md_SandboxTemplate.Fields().ByName("data")
}

var _ protoreflect.Message = (*fastReflection_SandboxTemplate)(nil)

type fastReflection_SandboxTemplate SandboxTemplate

func (x *SandboxTemplate) ProtoReflect() protoreflect.Message {
	return (*fastReflection_SandboxTemplate)(x)
}

func (x *SandboxTemplate) slowProtoReflect() protoreflect.Message {
	mi := &file_sourcenetwork_acp_core_sandbox_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_SandboxTemplate_messageType fastReflection_SandboxTemplate_messageType
var _ protoreflect.MessageType = fastReflection_SandboxTemplate_messageType{}

type fastReflection_SandboxTemplate_messageType struct{}

func (x fastReflection_SandboxTemplate_messageType) Zero() protoreflect.Message {
	return (*fastReflection_SandboxTemplate)(nil)
}
func (x fastReflection_SandboxTemplate_messageType) New() protoreflect.Message {
	return new(fastReflection_SandboxTemplate)
}
func (x fastReflection_SandboxTemplate_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_SandboxTemplate
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_SandboxTemplate) Descriptor() protoreflect.MessageDescriptor {
	return md_SandboxTemplate
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_SandboxTemplate) Type() protoreflect.MessageType {
	return _fastReflection_SandboxTemplate_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_SandboxTemplate) New() protoreflect.Message {
	return new(fastReflection_SandboxTemplate)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_SandboxTemplate) Interface() protoreflect.ProtoMessage {
	return (*SandboxTemplate)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_SandboxTemplate) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Name != "" {
		value := protoreflect.ValueOfString(x.Name)
		if !f(fd_SandboxTemplate_name, value) {
			return
		}
	}
	if x.Description != "" {
		value := protoreflect.ValueOfString(x.Description)
		if !f(fd_SandboxTemplate_description, value) {
			return
		}
	}
	if x.Data != nil {
		value := protoreflect.ValueOfMessage(x.Data.ProtoReflect())
		if !f(fd_SandboxTemplate_data, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_SandboxTemplate) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sourcenetwork.acp_core.SandboxTemplate.name":
		return x.Name != ""
	case "sourcenetwork.acp_core.SandboxTemplate.description":
		return x.Description != ""
	case "sourcenetwork.acp_core.SandboxTemplate.data":
		return x.Data != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcenetwork.acp_core.SandboxTemplate"))
		}
		panic(fmt.Errorf("message sourcenetwork.acp_core.SandboxTemplate does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SandboxTemplate) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "sourcenetwork.acp_core.SandboxTemplate.name":
		x.Name = ""
	case "sourcenetwork.acp_core.SandboxTemplate.description":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_SandboxTemplate) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "sourcenetwork.acp_core.SandboxTemplate.name":
		value := x.Name
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message sourcenetwork.acp_core.SandboxTemplate does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SandboxTemplate) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "sourcenetwork.acp_core.SandboxTemplate.name":
		x.Name = value.Interface().(string)
	case "sourcenetwork.acp_core.SandboxTemplate.description":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SandboxTemplate) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sourcenetwork.acp_core.SandboxTemplate.data":
		if x.Data == nil {
			x.Data = new(SandboxData)
		...
		return protoreflect.ValueOfMessage(x.Data.ProtoReflect())
	case "sourcenetwork.acp_core.SandboxTemplate.name":
		panic(fmt.Errorf("field name of message sourcenetwork.acp_core.SandboxTemplate is not mutable"))
	case "sourcenetwork.acp_core.SandboxTemplate.description":
		panic(fmt.Errorf("field description of message sourcenetwork.acp_core.SandboxTemplate is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcenetwork.acp_core.SandboxTemplate"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_SandboxTemplate) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sourcenetwork.acp_core.SandboxTemplate.name":
		return protoreflect.ValueOfString("")
	case "sourcenetwork.acp_core.SandboxTemplate.description":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_SandboxTemplate) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sourcenetwork.acp_core.SandboxTemplate", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_SandboxTemplate) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SandboxTemplate) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_SandboxTemplate) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_SandboxTemplate) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*SandboxTemplate)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SandboxTemplate: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SandboxTemplate: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (*SandboxTemplate) Descriptor() ([]byte, []int) {
	return file_sourcenetwork_acp_core_sandbox_proto_rawDescGZIP(), []int{4}
}
...
func (x *SandboxTemplate) GetData() *SandboxData {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_sourcenetwork_acp_core_sandbox_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x80, 0x01, 0x0a, 0x0f, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x54, 0x65, 0x6d,
	0x70, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73,
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x37, 0x0a, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x61, 0x63, 0x70, 0x5f, 0x63, 0x6f,
...
var file_sourcenetwork_acp_core_sandbox_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_sourcenetwork_acp_core_sandbox_proto_goTypes = []interface{}{
	...
	(*SandboxTemplate)(nil),   // 4: sourcenetwork.acp_core.SandboxTemplate
	(*Policy)(nil),            // 5: sourcenetwork.acp_core.Policy
	(*Relationship)(nil),      // 6: sourcenetwork.acp_core.Relationship
	(*PolicyTheorem)(nil),     // 7: sourcenetwork.acp_core.PolicyTheorem
	(*LocatedMessage)(nil),    // 8: sourcenetwork.acp_core.LocatedMessage
}
var file_sourcenetwork_acp_core_sandbox_proto_depIdxs = []int32{
	...
	5,  // 3: sourcenetwork.acp_core.SandboxCtx.policy:type_name -> sourcenetwork.acp_core.Policy
	6,  // 4: sourcenetwork.acp_core.SandboxCtx.relationships:type_name -> sourcenetwork.acp_core.Relationship
	7,  // 5: sourcenetwork.acp_core.SandboxCtx.policy_theorem:type_name -> sourcenetwork.acp_core.PolicyTheorem
	8,  // 6: sourcenetwork.acp_core.SandboxDataErrors.policy_errors:type_name -> sourcenetwork.acp_core.LocatedMessage
	8,  // 7: sourcenetwork.acp_core.SandboxDataErrors.relationships_errors:type_name -> sourcenetwork.acp_core.LocatedMessage
	8,  // 8: sourcenetwork.acp_core.SandboxDataErrors.theorems_errors:type_name -> sourcenetwork.acp_core.LocatedMessage
	1,  // 9: sourcenetwork.acp_core.SandboxTemplate.data:type_name -> sourcenetwork.acp_core.SandboxData
...
func file_sourcenetwork_acp_core_sandbox_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sourcenetwork_acp_core_sandbox_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
