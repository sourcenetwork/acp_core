...
var fileDescriptor_51a4aea7fe8278b3 = []byte{
	...
	,
}
...
func (m *ManagementGraph) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BackwardEdges) > 0 {
		keysForBackwardEdges := make([]string, 0, len(m.BackwardEdges))
		for k := range m.BackwardEdges {
			keysForBackwardEdges = append(keysForBackwardEdges, string(k))
		}
		github_com_cosmos_gogoproto_sortkeys.Strings(keysForBackwardEdges)
		for iNdEx := len(keysForBackwardEdges) - 1; iNdEx >= 0; iNdEx-- {
			v := m.BackwardEdges[string(keysForBackwardEdges[iNdEx])]
			baseI := i
			if v != nil {
				{
			...
			i -= len(keysForBackwardEdges[iNdEx])
			copy(dAtA[i:], keysForBackwardEdges[iNdEx])
			i = encodeVarintPolicyRecord(dAtA, i, uint64(len(keysForBackwardEdges[iNdEx])))
			i--
			dAtA[i] = 0xa
	...
	if len(m.ForwardEdges) > 0 {
		keysForForwardEdges := make([]string, 0, len(m.ForwardEdges))
		for k := range m.ForwardEdges {
			keysForForwardEdges = append(keysForForwardEdges, string(k))
		}
		github_com_cosmos_gogoproto_sortkeys.Strings(keysForForwardEdges)
		for iNdEx := len(keysForForwardEdges) - 1; iNdEx >= 0; iNdEx-- {
			v := m.ForwardEdges[string(keysForForwardEdges[iNdEx])]
			baseI := i
			if v != nil {
				{
					size, err := v.MarshalToSizedBuffer(dAtA[:i])
			...
			i -= len(keysForForwardEdges[iNdEx])
			copy(dAtA[i:], keysForForwardEdges[iNdEx])
			i = encodeVarintPolicyRecord(dAtA, i, uint64(len(keysForForwardEdges[iNdEx])))
			i--
			dAtA[i] = 0xa
			i = encodeVarintPolicyRecord(dAtA, i, uint64(baseI-i))
			i--
	...
	if len(m.Nodes) > 0 {
		...
		github_com_cosmos_gogoproto_sortkeys.Strings(keysForNodes)
		for iNdEx := len(keysForNodes) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintPolicyRecord(dAtA, i, uint64(len(keysForNodes[iNdEx])))
			i--
			dAtA[i] = 0xa
			i = encodeVarintPolicyRecord(dAtA, i, uint64(baseI-i))
			i--
...
func (m *ManagerEdges) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Edges) > 0 {
		keysForEdges := make([]string, 0, len(m.Edges))
		for k := range m.Edges {
			keysForEdges = append(keysForEdges, string(k))
		}
		github_com_cosmos_gogoproto_sortkeys.Strings(keysForEdges)
		for iNdEx := len(keysForEdges) - 1; iNdEx >= 0; iNdEx-- {
			v := m.Edges[string(keysForEdges[iNdEx])]
			baseI := i
			i--
			if v {
				dAtA[i] = 1
			...
			i--
			dAtA[i] = 0x10
			i -= len(keysForEdges[iNdEx])
			copy(dAtA[i:], keysForEdges[iNdEx])
			i = encodeVarintPolicyRecord(dAtA, i, uint64(len(keysForEdges[iNdEx])))
			i--
			dAtA[i] = 0xa
			i = encodeVarintPolicyRecord(dAtA, i, uint64(baseI-i))
			i--
