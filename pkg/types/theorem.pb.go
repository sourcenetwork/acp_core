...
func (m *PolicyTheoremResult) GetOk() bool {
	if m != nil {
		return m.Ok
	}
	return false
...
func (m *PolicyTheoremResult) GetTheoremCount() uint32 {
	if m != nil {
		return m.TheoremCount
	}
	return 0
}

func (m *PolicyTheoremResult) GetFailures() uint32 {
	if m != nil {
		return m.Failures
	}
	return 0
...
func (m *AnnotatedPolicyTheoremResult) GetOk() bool {
	if m != nil {
		return m.Ok
	}
	return false
...
func (m *AnnotatedPolicyTheoremResult) GetTheoremCount() uint32 {
	if m != nil {
		return m.TheoremCount
	}
	return 0
...
func (m *AnnotatedPolicyTheoremResult) GetFailures() uint32 {
	if m != nil {
		return m.Failures
	}
	return 0
...
var fileDescriptor_0a37058f4cb4907c = []byte{
	...
	,
}
...
func (m *PolicyTheoremResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Failures != 0 {
		i = encodeVarintTheorem(dAtA, i, uint64(m.Failures))
		i--
		dAtA[i] = 0x38
	}
	if m.TheoremCount != 0 {
		i = encodeVarintTheorem(dAtA, i, uint64(m.TheoremCount))
		i--
		dAtA[i] = 0x30
	}
	if m.Ok {
...
func (m *PolicyTheoremResult) Size() (n int) {
	...
	if m.TheoremCount != 0 {
		n += 1 + sovTheorem(uint64(m.TheoremCount))
	}
	if m.Failures != 0 {
		n += 1 + sovTheorem(uint64(m.Failures))
	}
	return n
}
...
func (m *PolicyTheoremResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TheoremCount", wireType)
			}
			m.TheoremCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TheoremCount |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
