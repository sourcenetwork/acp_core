...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_336d1bd8c1c384ea, []int{0}
}
...
func (*BuildInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_336d1bd8c1c384ea, []int{1}
}
...
func init() {
	proto.RegisterType((*Params)(nil), "sourcenetwork.acp_core.Params")
	proto.RegisterType((*BuildInfo)(nil), "sourcenetwork.acp_core.BuildInfo")
}

func init() {
	proto.RegisterFile("sourcenetwork/acp_core/system.proto", fileDescriptor_336d1bd8c1c384ea)
}

var fileDescriptor_336d1bd8c1c384ea = []byte{
	// 184 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x2e, 0xce, 0x2f, 0x2d,
	0x4a, 0x4e, 0xcd, 0x4b, 0x2d, 0x29, 0xcf, 0x2f, 0xca, 0xd6, 0x4f, 0x4c, 0x2e, 0x88, 0x4f, 0xce,
	0x2f, 0x4a, 0xd5, 0x2f, 0xae, 0x2c, 0x2e, 0x49, 0xcd, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17,
	0x12, 0x43, 0x51, 0xa4, 0x07, 0x53, 0xa4, 0xc4, 0xc1, 0xc5, 0x16, 0x90, 0x58, 0x94, 0x98, 0x5b,
	0xac, 0x64, 0xcb, 0xc5, 0xe9, 0x54, 0x9a, 0x99, 0x93, 0xe2, 0x99, 0x97, 0x96, 0x2f, 0x24, 0xc6,
	0xc5, 0x96, 0x9c, 0x9f, 0x9b, 0x9b, 0x59, 0x22, 0xc1, 0xa8, 0xc0, 0xa8, 0xc1, 0x19, 0x04, 0xe5,
	0x09, 0x49, 0x70, 0xb1, 0x97, 0xa5, 0x16, 0x15, 0x67, 0xe6, 0xe7, 0x49, 0x30, 0x81, 0x25, 0x60,
	...
	0x2c, 0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0xc7, 0xe1, 0xd4, 0x82, 0xec, 0x74, 0xfd,
	0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0xb0, 0x73, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff,
	0xab, 0x91, 0x02, 0x10, 0xd5, 0x00, 0x00, 0x00,
}
...
func (m *BuildInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Version) > 0 {
		...
		i = encodeVarintSystem(dAtA, i, uint64(len(m.Version)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Commit) > 0 {
		...
		i = encodeVarintSystem(dAtA, i, uint64(len(m.Commit)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
