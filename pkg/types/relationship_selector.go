...
// Resources sets the Selector to filter Relationships whose Object resource name are resourceName
func (b *RelationshipSelectorBuilder) Resource(resourceName string) *RelationshipSelectorBuilder {
	b.objSelector = &ObjectSelector{
		Selector: &ObjectSelector_ResourcePredicate{
			ResourcePredicate: resourceName,
		},
	}
	return b
}
...
func (b *RelationshipSelectorBuilder) AnyRelation() *RelationshipSelectorBuilder {
	b.relationSelector = &RelationSelector{
