...
func (*RelationshipSelector) Descriptor() ([]byte, []int) {
	return fileDescriptor_62e97b38e5587591, []int{0}
}
...
func (*ObjectSelector) Descriptor() ([]byte, []int) {
	return fileDescriptor_62e97b38e5587591, []int{1}
}
...
type ObjectSelector_ResourcePredicate struct {
	ResourcePredicate string `protobuf:"bytes,3,opt,name=resource_predicate,json=resourcePredicate,proto3,oneof" json:"resource_predicate,omitempty"`
}
...
func (m *ObjectSelector) GetResourcePredicate() string {
	if x, ok := m.GetSelector().(*ObjectSelector_ResourcePredicate); ok {
...
func (*RelationSelector) Descriptor() ([]byte, []int) {
	return fileDescriptor_62e97b38e5587591, []int{2}
}
...
func (*SubjectSelector) Descriptor() ([]byte, []int) {
	return fileDescriptor_62e97b38e5587591, []int{3}
}
...
func (*WildcardSelector) Descriptor() ([]byte, []int) {
	return fileDescriptor_62e97b38e5587591, []int{4}
}
...
func init() {
	proto.RegisterType((*RelationshipSelector)(nil), "sourcenetwork.acp_core.RelationshipSelector")
	proto.RegisterType((*ObjectSelector)(nil), "sourcenetwork.acp_core.ObjectSelector")
	proto.RegisterType((*RelationSelector)(nil), "sourcenetwork.acp_core.RelationSelector")
	proto.RegisterType((*SubjectSelector)(nil), "sourcenetwork.acp_core.SubjectSelector")
	proto.RegisterType((*WildcardSelector)(nil), "sourcenetwork.acp_core.WildcardSelector")
}

func init() {
	proto.RegisterFile("sourcenetwork/acp_core/relationship_selector.proto", fileDescriptor_62e97b38e5587591)
}

var fileDescriptor_62e97b38e5587591 = []byte{
	// 381 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *ObjectSelector_ResourcePredicate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ObjectSelector_ResourcePredicate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.ResourcePredicate)
	copy(dAtA[i:], m.ResourcePredicate)
	i = encodeVarintRelationshipSelector(dAtA, i, uint64(len(m.ResourcePredicate)))
	i--
	dAtA[i] = 0x1a
	return len(dAtA) - i, nil
}
...
func (m *ObjectSelector_ResourcePredicate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.ResourcePredicate)
	n += 1 + l + sovRelationshipSelector(uint64(l))
	return n
}
...
func (m *ObjectSelector) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResourcePredicate", wireType)
			}
			...
			m.Selector = &ObjectSelector_ResourcePredicate{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRelationshipSelector(dAtA[iNdEx:])
