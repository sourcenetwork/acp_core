...
type Principal struct {
	...
	Identifier string        `protobuf:"bytes,2,opt,name=indentifier,proto3" json:"indentifier,omitempty"`
}
...
func (m *Principal) GetIndentifier() string {
	if m != nil {
		return m.Identifier
	}
	return ""
...
var fileDescriptor_53d7ad510952fb67 = []byte{
	...
	0x2f, 0xc9, 0x17, 0x12, 0x43, 0x51, 0xa7, 0x07, 0x53, 0xa7, 0x94, 0xc1, 0xc5, 0x19, 0x00, 0x53,
	0x2a, 0x64, 0xc9, 0xc5, 0x92, 0x9d, 0x99, 0x97, 0x22, 0xc1, 0xa8, 0xc0, 0xa8, 0xc1, 0x67, 0xa4,
	0xaa, 0x87, 0x5d, 0x8f, 0x1e, 0x5c, 0x83, 0x77, 0x66, 0x5e, 0x4a, 0x10, 0x58, 0x8b, 0x90, 0x02,
	0x17, 0x77, 0x66, 0x5e, 0x4a, 0x6a, 0x5e, 0x49, 0x66, 0x5a, 0x66, 0x6a, 0x91, 0x04, 0x93, 0x02,
	0xa3, 0x06, 0x67, 0x10, 0xb2, 0x90, 0x96, 0x21, 0x17, 0x2f, 0x8a, 0x46, 0x21, 0x5e, 0x2e, 0x4e,
	0xc7, 0xbc, 0xfc, 0xbc, 0xca, 0xdc, 0xfc, 0xd2, 0x62, 0x01, 0x06, 0x21, 0x0e, 0x2e, 0x96, 0xa0,
	0xfc, 0xfc, 0x12, 0x01, 0x46, 0x21, 0x76, 0x2e, 0x66, 0x17, 0x4f, 0x17, 0x01, 0x26, 0x27, 0xd7,
	...
	0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0xc7, 0x15, 0x02, 0xd9, 0xe9, 0xfa, 0x25, 0x95, 0x05, 0xa9,
	0xc5, 0x49, 0x6c, 0xe0, 0x20, 0x30, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x33, 0x8e, 0xd7, 0x73,
	0x2c, 0x01, 0x00, 0x00,
}
...
func (m *Principal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Indentifier", wireType)
			}
